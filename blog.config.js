...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'PicklePiccolo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://edu.pickle.icu/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Education, Notion, Blog', // 网站关键词 英文逗号隔开
